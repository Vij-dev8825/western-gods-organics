...
export const IconTrophy = (p) => (
  <I {...p}>
    ...
    <path d="M8 5.6H5.4v1.6a3 3 0 0 0 2.8 3M16 5.6h2.6v1.6a3 3 0 0 1-2.8 3" />
    <path d="M12 13.4v3.2M9 19.8h6M9.6 16.6h4.8l.6 3.2H9z" />
  </I>
);

/* WhatsApp's mark is a filled glyph, so it opts out of the shared stroke. */
export const IconWhatsApp = (p) => (
  <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false" {...p}>
    <path d="M12.04 2.2c-5.42 0-9.82 4.4-9.82 9.82 0 1.73.45 3.42 1.31 4.91L2.2 21.8l4.98-1.3a9.78 9.78 0 0 0 4.86 1.28h.01c5.41 0 9.81-4.4 9.81-9.82 0-2.62-1.02-5.09-2.87-6.94a9.75 9.75 0 0 0-6.95-2.88Zm0 17.98h-.01a8.15 8.15 0 0 1-4.15-1.14l-.3-.18-3.08.81.82-3-.19-.31a8.13 8.13 0 0 1-1.25-4.34c0-4.5 3.66-8.16 8.17-8.16a8.11 8.11 0 0 1 5.77 2.4 8.1 8.1 0 0 1 2.39 5.77c0 4.5-3.66 8.15-8.17 8.15Zm4.48-6.1c-.25-.13-1.45-.72-1.68-.8-.22-.08-.39-.13-.55.12-.16.25-.63.8-.77.97-.14.16-.28.18-.53.06-.24-.12-1.04-.38-1.98-1.22-.73-.65-1.22-1.46-1.36-1.7-.14-.26-.02-.4.11-.52.11-.11.25-.29.37-.43.13-.15.17-.25.25-.42.09-.16.04-.31-.02-.43-.06-.12-.55-1.33-.76-1.82-.2-.48-.4-.41-.55-.42h-.47c-.16 0-.42.06-.64.31-.22.25-.84.82-.84 2 0 1.18.86 2.32.98 2.48.12.16 1.69 2.58 4.09 3.62.57.25 1.02.4 1.37.5.58.19 1.1.16 1.52.1.46-.07 1.42-.58 1.62-1.14.2-.56.2-1.04.14-1.14-.06-.1-.22-.16-.47-.28Z" />
  </svg>
);
